					...
					<div className="flex flex-col gap-2">
						...
						<div className="flex flex-col sm:flex-row gap-4">
							<button
								...
								onClick={() => handleProjectShapeChange("10px")}
							>
								{appearance.projectShape === "10px" && "Seleccionado"}
							</button>
							<button
					...
					<div className="flex flex-col gap-2">
						...
						<div className="flex flex-col sm:flex-row gap-4">
							<div
								...
								onClick={() => handleProjectPictureShapeChange("10px")}
							>
								<div className="border-2 border-white bg-neutral-900 w-12 h-12 rounded-lg"></div>
								<p className="mt-3">
									{appearance.projectPictureShape === "10px" && "Seleccionado"}
								</p>
							</div>
							<div
								className="border-2 border-white p-2 bg-neutral-900 w-full sm:w-56 cursor-pointer flex gap-8"
