...
export function ProjectCard({ project, backgroundColor }) {
  ...
  return (
    <>
      <div
        className={`w-[90%] md:w-[80%] lg:w-[100%] transition-all duration-300 overflow-hidden flex justify-between text-white rounded-xl shadow-gray shadow-md p-4 sm:p-6 md:p-7 mb-3 relative bg-neutral-800 ${
          isExpanded
