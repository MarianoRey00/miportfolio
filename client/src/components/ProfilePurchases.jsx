...
function ProfilePurchases({ user }) {
  ...
  return (
    <>
      {/* <div className="p-4 border border-white rounded-lg shadow-md shadow-neutral-700 mb-4">
        <p>
      ...
      {/* <div className="space-y-4">
        {sales.map((sale) => (
          <div
            key={sale.id}
            className="rounded-xl border border-border bg-muted/50 p-6 shadow-sm transition-colors hover:bg-muted"
          >
